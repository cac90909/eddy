...
from shared.operation.domain import ArgumentSpec as ArgSpec
from shared.operation.domain import OperationSpec as OpSpec
from shared.operation.service import OperationService as OpSvc

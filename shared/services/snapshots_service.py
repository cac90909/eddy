...
class SnapshotsService:
    ...
    def get_all_snapshots(self, user_id):
        ...
        debug_print_vars(user_id=user_id, snapshots=snapshots)
        return snapshots
    ...
    def get_snapshot(self, user_id, snapshot_id):
        ...
        debug_print_vars(user_id=user_id, snapshot=snapshot)
        return snapshot
    ...
    def delete_snapshot(self, user_id, snapshot_id):
        ...
        debug_print_vars(user_id=user_id, snapshot_id=snapshot_id)

...
class UniversalRepository:
    ...
    # Works on both list columns and single value columns
    def get_unique_column_values(self, user_data_queryset, column_name):
        """
        Retrieve unique values from a column. If the column is an array field,
        unnest the list values; otherwise, simply return the distinct values.
        ...
        """
        # Use the Universal model instead of self.model.
        ...
        if isinstance(field, ArrayField):
            ...
            # For non-array fields, simply use distinct.
    ...
    def filter_data(user_data_queryset, column_name, filter_value, filter_type):
        ...
        debug_print(column_name, filter_value, filter_type, user_data_queryset)
